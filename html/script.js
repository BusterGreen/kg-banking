const bankingApp = Vue.createApp({
    ...
    methods: {
        ...
        withdrawMoney() {
            ...
            axios
                .post("https://kg-banking/withdraw", {
        ...
        internalTransfer() {
            ...
            axios
                .post("https://kg-banking/internalTransfer", {
        ...
        externalTransfer() {
            ...
            axios
                .post("https://kg-banking/externalTransfer", {
        ...
        orderDebitCard() {
            ...
            axios
                .post("https://kg-banking/orderCard", {
                    pin: this.debitPin,
                })
                .then((response) => {
                    if (response.data.success) {
        ...
        openAccount() {
            ...
            axios
                .post("https://kg-banking/openAccount", {
        ...
        renameAccount() {
            ...
            axios
                .post("https://kg-banking/renameAccount", {
        ...
        deleteAccount() {
            ...
            axios
                .post("https://kg-banking/deleteAccount", {
        ...
        removeUserFromAccount() {
            ...
            axios
                .post("https://kg-banking/removeUser", {
                    accountName: this.manageAccountName.name,
                    userName: this.manageUserName,
                })
                .then((response) => {
